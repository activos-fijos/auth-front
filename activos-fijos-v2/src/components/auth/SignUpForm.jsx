...
const SignUpForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.confirmPassword) newErrors.confirmPassword ="Por favor verifica la contraseña";
    ...
    <div className="d-flex flex-center flex-column flex-lg-row-fluid">
      <div className="w-lg-500px p-10">
        <form className="form w-100" id="kt_sign_up_form" onSubmit={handleSubmit}>
          ...
          <Input className="fv-row mb-8" type="email" name="email" placeholder="Correo" value={formData.email} onChange={handleChance} error={errors.email} />

          <PasswordInput  className="fv-row mb-8" name="password" placeholder="Contraseña" value={formData.password} onChange={handleChance} showMeter={true} error={errors.password} />
          
          <PasswordInput className="fv-row mb-8" name="confirmPassword" placeholder="Repetir contraseña" value={formData.confirmPassword} onChange={handleChance} error={errors.confirmPassword} />
